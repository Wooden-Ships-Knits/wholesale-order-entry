...
// store too close to a new account's store. Informational only — never
  ...
  return (
    <div className="conflict-modal-overlay" role="dialog" aria-modal="true" aria-labelledby="conflict-modal-title">
      <div className="conflict-modal">
        <h2 id="conflict-modal-title">⚠ Possible store conflict</h2>
        <p>
          {conflicting} existing store{conflicting === 1 ? ' is' : 's are'} within a{' '}
